...
// Close modal.
$(document).on('click','.ajax-modal button.close','.ajax-modal a.close', function(e){
   	e.preventDefault();
...
// Prev arrow
$(document).on('click','.ajax-modal:not(.calendar) button.left','.ajax-modal:not(.calendar) a.left', function(e){
	e.preventDefault();
...
// Next arrow
$(document).on('click','.ajax-modal:not(.calendar) button.right','.ajax-modal:not(.calendar) a.right', function(e){
    e.preventDefault();
...
function ajaxClearHash(){
	...
	$('.ajax-modal a.close').on('click', function(){
		window.location.hash = '';
	});
}
